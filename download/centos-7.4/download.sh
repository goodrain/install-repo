...
base_pkg=(yum-utils tar jq wget curl nano perl tree lsof htop nload net-tools telnet rsync git ntp ntpdate pwgen iproute bash-completion createrepo sshpass python2-pip pwgen expect ansible)
