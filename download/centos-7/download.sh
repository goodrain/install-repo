...
base_pkg=(tar jq wget curl nano perl tree lsof htop nload net-tools telnet rsync git ntp ntpdate pwgen iproute bash-completion createrepo sshpass python2-pip pwgen expect ansible)
system_pkg=(conntrack-tools iotop lvm2 dstat psmisc socat chrony ipset ipvsadm bind-utils keepalived )
